...
int rest_caniot_records(http_request_t *req, http_response_t *resp);
...
int rest_devices_caniot_attr_read(http_request_t *req, http_response_t *resp);

int rest_devices_caniot_attr_write(http_request_t *req, http_response_t *resp);
