...
static const struct route_descr root_api_test[] = {
	...
	SECTION("route_args", 0u, root_api_test_route_args, 
		ARRAY_SIZE(root_api_test_route_args), 0u),
	...
	SECTION(":s", ARG_STR, root_api_test_zs, 
		ARRAY_SIZE(root_api_test_zs), 0u),
};
#endif
...
static const struct route_descr root_api_if[] = {
	SECTION("can", 0u, root_api_if_can, 
		ARRAY_SIZE(root_api_if_can), 0u),
};
#endif
...
static const struct route_descr root_api_devices_caniot_didzu_endpoint[] = {
	SECTION("blc0", 0u, root_api_devices_caniot_didzu_endpoint_blc0, 
		ARRAY_SIZE(root_api_devices_caniot_didzu_endpoint_blc0), 0u),
	SECTION("blc1", 0u, root_api_devices_caniot_didzu_endpoint_blc1, 
		ARRAY_SIZE(root_api_devices_caniot_didzu_endpoint_blc1), 0u),
	SECTION("blc", 0u, root_api_devices_caniot_didzu_endpoint_blc, 
		ARRAY_SIZE(root_api_devices_caniot_didzu_endpoint_blc), 0u),
	SECTION("ep:u", ARG_UINT, root_api_devices_caniot_didzu_endpoint_epzu, 
		ARRAY_SIZE(root_api_devices_caniot_didzu_endpoint_epzu), 0u),
};
#endif

#if defined(CONFIG_APP_CANIOT_CONTROLLER)
static const struct route_descr root_api_devices_caniot_didzu[] = {
	SECTION("endpoint", 0u, root_api_devices_caniot_didzu_endpoint, 
		ARRAY_SIZE(root_api_devices_caniot_didzu_endpoint), 0u),
	SECTION("attribute", 0u, root_api_devices_caniot_didzu_attribute, 
		ARRAY_SIZE(root_api_devices_caniot_didzu_attribute), 0u),
...
static const struct route_descr root_api_devices_caniot[] = {
	...
	SECTION("did:u", ARG_UINT, root_api_devices_caniot_didzu, 
		ARRAY_SIZE(root_api_devices_caniot_didzu), 0u),
};
#endif
...
#endif
#if defined(CONFIG_APP_CANIOT_CONTROLLER)
	SECTION("caniot", 0u, root_api_devices_caniot, 
		ARRAY_SIZE(root_api_devices_caniot), 0u),
#endif
};
...
static const struct route_descr root_api_files_1zs_2zs[] = {
	LEAF("", POST, http_file_upload, http_file_upload, REST),
	SECTION("3:s", ARG_STR, root_api_files_1zs_2zs_3zs, 
		ARRAY_SIZE(root_api_files_1zs_2zs_3zs), REST),
	LEAF("", GET, http_file_download, NULL, BINARY),
};

static const struct route_descr root_api_files_1zs[] = {
	LEAF("", POST, http_file_upload, http_file_upload, REST),
	SECTION("2:s", ARG_STR, root_api_files_1zs_2zs, 
		ARRAY_SIZE(root_api_files_1zs_2zs), REST),
	LEAF("", GET, http_file_download, NULL, BINARY),
};

static const struct route_descr root_api_files[] = {
	LEAF("", POST, http_file_upload, http_file_upload, REST),
	SECTION("1:s", ARG_STR, root_api_files_1zs, 
		ARRAY_SIZE(root_api_files_1zs), REST),
	LEAF("", GET, http_file_download, NULL, BINARY),
#if defined(CONFIG_LUA)
...
static const struct route_descr root_api[] = {
	...
	SECTION("files", 0u, root_api_files, 
		ARRAY_SIZE(root_api_files), REST),
#if defined(CONFIG_LUA)
	SECTION("lua", 0u, root_api_lua, 
		ARRAY_SIZE(root_api_lua), 0u),
#endif
	...
	SECTION("devices", 0u, root_api_devices, 
		ARRAY_SIZE(root_api_devices), 0u),
	SECTION("device", 0u, root_api_device, 
		ARRAY_SIZE(root_api_device), 0u),
	SECTION("ha", 0u, root_api_ha, 
		ARRAY_SIZE(root_api_ha), 0u),
#if defined(CONFIG_APP_CAN_INTERFACE)
	SECTION("if", 0u, root_api_if, 
		ARRAY_SIZE(root_api_if), 0u),
#endif
#if defined(CONFIG_APP_HTTP_TEST_SERVER)
	SECTION("test", 0u, root_api_test, 
		ARRAY_SIZE(root_api_test), 0u),
#endif
};
...
static const struct route_descr root[] = {
	...
	SECTION("api", 0u, root_api, 
		ARRAY_SIZE(root_api), 0u),
};
