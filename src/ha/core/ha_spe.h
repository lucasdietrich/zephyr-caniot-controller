...
typedef enum {
	...
	HA_DEV_EP_CANIOT_BLC0,
	HA_DEV_EP_CANIOT_BLC1,
	HA_DEV_EP_CANIOT_BLC2,
	HA_DEV_EP_CANIOT_BLC3,
	HA_DEV_EP_CANIOT_BLC4,
	HA_DEV_EP_CANIOT_BLC5,
	HA_DEV_EP_CANIOT_BLC6,
	HA_DEV_EP_CANIOT_BLC7,

	/* CANIOT specific application endpoints */
	HA_DEV_EP_CANIOT_HEATING,
	HA_DEV_EP_CANIOT_SHUTTERS,
} ha_endpoint_id_t;
