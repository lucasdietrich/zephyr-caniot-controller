...
{
	save_caniot_temperature(blt->temperatures,
				ARRAY_SIZE(blt->temperatures),
				0U,
				can_buf->int_temperature,
				HA_DEV_SENSOR_TYPE_EMBEDDED);
	save_caniot_temperature(blt->temperatures,
				ARRAY_SIZE(blt->temperatures),
				1U,
				can_buf->ext_temperature,
				HA_DEV_SENSOR_TYPE_EXTERNAL1);
	save_caniot_temperature(blt->temperatures,
				ARRAY_SIZE(blt->temperatures),
				2U,
				can_buf->ext_temperature2,
				HA_DEV_SENSOR_TYPE_EXTERNAL2);
	save_caniot_temperature(blt->temperatures,
				ARRAY_SIZE(blt->temperatures),
				3U,
				can_buf->ext_temperature3,
...
static const struct ha_data_descr ha_cmd_caniot_blc0_descr[] = {
	HA_DATA_DESCR(
		struct ha_cmd_caniot_blc0, oc1, HA_DATA_XPS, HA_ASSIGN_OPEN_COLLECTOR),
	HA_DATA_DESCR(
		struct ha_cmd_caniot_blc0, oc2, HA_DATA_XPS, HA_ASSIGN_OPEN_COLLECTOR),
...
static const struct ha_data_descr ha_ds_caniot_ep_shutters_control_descr[] = {
	HA_DATA_DESCR_UNASSIGNED(struct ha_ds_caniot_shutters_control,
				 shutters[0u],
...
static const struct ha_data_descr ha_cmd_caniot_ep_shutters_control_descr[] = {
	HA_DATA_DESCR_UNASSIGNED(struct ha_cmd_caniot_shutters_control,
				 shutters[0u],
				 HA_DATA_SHUTTER_POSITION),
	HA_DATA_DESCR_UNASSIGNED(struct ha_cmd_caniot_shutters_control,
				 shutters[1u],
