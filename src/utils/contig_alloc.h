...
#define Z_CONFIG_BUF_SYM(_name) (_contig_buf##_name)
...
#define CONTIG_INIT(_buf, _size)                                                         \
	{                                                                                    \
		.allocated = 0u, .size = _size, .buf = _buf,                                     \
	}
...
#define CONTIG_DEFINE(_name, _buf, _size) struct contig name = CONTIG_INIT(_buf, _size)
